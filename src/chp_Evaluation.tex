...
Wenn die Schaltfläche "`Terminal"' aktiviert ist, kann eine erfolgte Texteingabe nicht mehr mit der Rücktaste korrigiert werden. Bei deaktivierter Schaltfläche ist die Korrektur möglich. Die Konsole mangelt es folglich an Fehlertolernaz, was einer schlechten Usability entspricht. 
