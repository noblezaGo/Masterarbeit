...
Die Bewertung der Anforderungen soll qualitativ erfolgen anhand von Meinungen befragter Entwickler. Die Anforderungen werden eingeordnet in vier Klassen:

\begin{itemize}
	\item Klasse A: Anforderung, die essenziell wichtige Grundfunktionalitäten bereitstellt
	\item Klasse B: Anforderung, die wichtige Funktionalitäten bereitstellt
	\item Klasse C: Anforderung, die mäßig wichtige Funktionalitäten bereitstellt
	\item Klasse D: Anforderung, die wenige wichtige Funktionalitäten bereitstellt
\end{itemize}
...
\begin{itemize}
	...
	Klasse A, da als Grundfunktionalität einer IDE einzustufen.
	...
	Macht die Codeentwicklung bedeutend effektiver, da dem Benutzer Tipparbeit erspart bleibt. Weiterer Vorteil ist die Fehlervermeidung durch Tippfehler. Deshalb Einstufung in Klasse B. 
	...
	Das Auffinden von Variablen und Methoden im Skript wird erheblich erleichtert. Bei Umbenennung von Variablen oder Methoden wird viel Zeit eingespart und es werden Tippfehler vermieden. Klasse B
	...
	Fördert die Fehlertoleranz. Klasse B
...
\begin{itemize}
	\item Anzeige aller mit dem PC verbundenen GIGABOXEN
	
	\emph{Beschreibung:} 
	
	Alle GIGABOXEN, die mit dem PC per Kabel oder Bluetooth verbunden sind, werden aufgelistet. Es werden Geräteinformationen wie z.B. Modellname, Seriennummer bereitgestellt.
	...
	Wird als Grundfunktionalität eingestuft, Klasse A. 
...
\subsection{PAWN-Compiler}
	...
	Das Kompilieren ist eine Grundfunktionalität und wird deshalb als Klasse A eingestuft.
...
\subsection{Beschreiben/Auslesen des Flash-Speichers der GIGABOX}
	...
	Die Übertragung von Skripten vom PC auf eine GIGABOX über die USB-Schnittstelle wird als Grundfunktionalität (Klasse A) bewertet. Die Übertragung von der GIGABOX auf den PC über die USB-Schnittstelle ist für den Entwickler sehr nützlich, aber nicht unbedingt notwendig und wird deshalb als Klasse B eingestuft.
Bluetooth-Übertragung wird in Klasse C eingestuft, da es wenige Use-Cases gibt, bei denen eine Funkübertragung Vorteile gegenüber der Kabelübertragung bietet. Ein möglicher Use-Case wäre eine schwer zugängliche GIGABOX im Fahrzeug, auf die ein neues Skript aufgespielt werden soll. Eine Übertragung per Bluetooth würde einen aufwändigen Ausbau der GIGABOX aus dem Fahrzeug ersparen.	
...
\subsection{Steuern und Beobachten von Ein-/Ausgängen und Timern}
	...
	Die Zustände der digitalen und analogen Ausgänge sowie der internen Timer sollen gesteuert und beobachtet werden können. 
	CAN- und LIN-Botschaften sollen gesendet und empfangen werden können. Dabei soll einmaliges und zyklisches Senden von Botschaften möglich sein. 
	Zusätzlich soll die Möglichkeit bestehen, Buskommunikation innerhalb eines Zeitfensters mitzuloggen. Alle Busbotschaften, die innerhalb dieses Zeitfensters auf dem Bus liegen, sollen dabei mit Zeitstempel gelistet werden. 
